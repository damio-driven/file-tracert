...
import { jobBlockDetail, jobRow, jobState } from '../src/screens.js';
 ...
 * safety margin. Space is only reserved for **cross-volume** moves, and this suite has exactly one
 * catalogable volume — a second one would mean writing outside the sandbox and deleting into the
 * recycle bin. That path is covered on real drives by the hardware harness and, on the numbers, by
 * xUnit.
 */
test.describe('Coda', () => {
